...
const PaymentProcessing = {
    init: function() {
        ...
        console.log('PaymentProcessing initialized');
    },
    ...
    selectPaymentMethod: function(methodElement) {
        ...
        this.selectedPaymentMethod = methodElement.getAttribute('data-method');

        // Update hidden input
        document.getElementById('paymentMethodInput').value = this.selectedPaymentMethod;

        // Show appropriate preview
        this.showPaymentPreview(this.selectedPaymentMethod);

        // Enable pay button
        document.getElementById('payNowBtn').disabled = false;
    },

    showPaymentPreview: function(method) {
        // Hide all previews
        const previews = ['cardPreview', 'upiPreview', 'netbankingPreview', 'walletPreview'];
        ...
        const previewId = method + 'Preview';
        const selectedPreview = document.getElementById(previewId);
        if (selectedPreview) {
    ...
    handlePaymentSubmission: function(event) {
        ...
        console.log('Processing fake payment with method:', this.selectedPaymentMethod);
        // Form will submit normally to server for fake processing
    }
};
